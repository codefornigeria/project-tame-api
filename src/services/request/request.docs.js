/**
 * @api {get} /request/:id Request Request information
 * @apiName GetRequest
 * @apiGroup Request
 *
 * @apiParam {Number} id Request unique ID.
 *
 * @apiSuccess {String} _id ID of the Request* 
 * @apiSuccess {String} name Name of the Request
 *
 ...
 * @apiGroup Request
 *
 * @apiParam {String} id Request unique ID.

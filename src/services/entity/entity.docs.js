/**
 * @api {get} /entity/:id Request entity information
 * @apiName GetEntity
 * @apiGroup Entity
 *
 * @apiParam {Number} id Entity unique ID.
 *
 * @apiSuccess {String} _id ID of the Entity* 
 ...
 * @apiGroup Entity
 *
 * @apiParam {String} id Entity unique ID.
 * @apiParam {String} name Entity name
 *
